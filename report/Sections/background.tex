...
A common misconception about the quantum threat is that it only becomes relevant when sufficiently large quantum computers become available, but this misconception overlooks an already active risk model known as the ``harvest now, decrypt later'' (HNDL) \cite{hndl}.
...
\subsubsection{Lattice-Based Cryptography (ML-KEM)}
