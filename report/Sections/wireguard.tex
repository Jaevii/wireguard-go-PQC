...
\begin{bytefield}[bitwidth=0.5em, endianness=big, bitformatting=\tiny]{64}
  ...
  \wordbox{4}{\texttt{ephemeral} — Curve25519 public key (32 B)} \\
  \wordbox{6}{\texttt{static\_encrypted} — encrypted static Curve25519 public key + AEAD tag (48 B)} \\
  \wordbox{4}{\texttt{timestamp\_encrypted} — encrypted timestamp + AEAD tag (28 B)} \\
