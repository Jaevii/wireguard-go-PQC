...
The primary C implementation of WireGuard is written in less than \num{4000} lines of code, excluding cryptographic primitives, compared to the \num{100000} to \num{400000} lines of the OpenVPN and IPsec implementations. This makes the codebase small enough for a single person to read and understand in full, which has direct benefits: a smaller attack surface, easier auditing, and easier to maintain.
